...
public abstract class DemandPredictionModule {
  ...
  // reads a .npy file and returns a (flattened) Numpy array
    ...
    //subclasses which extend the demand model with specific implementations

    class DNNModel extends DemandPredictionModule {
    ...
    //TODO implement the frequentist model
    class FrequentistModel extends DemandPredictionModule {
        public FrequentistModel(int height, int width, boolean debug, Communicator comm) {
            super(height, width, debug, comm);
        }
